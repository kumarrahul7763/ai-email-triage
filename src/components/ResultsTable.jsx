          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                ...
                <th className="text-left py-4 px-5 text-sm font-bold text-gray-700 uppercase tracking-wider">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {results.map((result, index) => (
                <>
                  <tr 
                    key={result.id || index} 
                    className="hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-purple-50/50 transition-all duration-200 cursor-pointer"
                  ...
                  {expandedRow === index && result.explanation && (
                    <tr key={`explanation-${result.id || index}`}>
